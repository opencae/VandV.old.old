...
set key below box
plot "exptData/x0.8off.dat" index 0 using 3:2 with p pt 1 lc 0 title "Exp.", "< cat ../postProcessing/sets/*/section_08_U.xy" using ($2)/34.6:($1)/0.42 with l lt 1 title "CFD"
