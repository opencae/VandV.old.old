...
set key below box
plot "plot/exptData/x1.2off.dat" index 0 using 3:2 with p pt 1 lc 0 title "Exp.", "< cat postProcessing/sample/*/section_12_U.xy" using ($2)/34.6:($1)/0.42 with l lt 1 title "CFD"
