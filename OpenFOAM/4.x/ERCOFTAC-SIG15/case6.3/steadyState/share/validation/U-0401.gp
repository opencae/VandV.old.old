...
plot \
     "../validation/exptData/mu__0401.dat" using (Ux($2)):(Z2($1)) with p pt 1 lc 0 title "Exp.",\
     "< cat ../postProcessing/sets/*/mu_0401_Ux.xy" using (Ux($2)):(Z1($1)) with l lt 1 title "CFD"
